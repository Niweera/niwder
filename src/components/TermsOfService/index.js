...
const TermsOfService = () => {
  return (
    <div className="container">
      ...
      <p>
        By accessing this Website, accessible from https://niwder.niweera.gq,
      ...
      <p>
        ...
        on Niwder.io's Website for personal, non-commercial transitory viewing
      ...
      <ul>
        ...
        <li>
          attempt to reverse engineer any software contained on Niwder.io's
          Website;
        </li>
        <li>
      ...
      <p>
        This will let Niwder.io to terminate upon violations of any of these
      ...
      <p>
        All the materials on Niwder.io’s Website are provided "as is". Niwder.io
        makes no warranties, may it be expressed or implied, therefore negates
        all other warranties. Furthermore, Niwder.io does not make any
      ...
      <p>
        Niwder.io or its suppliers will not be hold accountable for any damages
        that will arise with the use or inability to use the materials on
        Niwder.io’s Website, even if Niwder.io or an authorize representative of
      ...
      <p>
        The materials appearing on Niwder.io’s Website may include technical,
        typographical, or photographic errors. Niwder.io will not promise that
        any of the materials in this Website are accurate, complete, or current.
        Niwder.io may change the materials contained on its Website at any time
        without notice. Niwder.io does not make any commitment to update the
        materials.
      </p>
      ...
      <p>
        Niwder.io has not reviewed all of the sites linked to its Website and is
        not responsible for the contents of any such linked site. The presence
        of any link does not imply endorsement by Niwder.io of the site. The use
      ...
      <p>
        Niwder.io may revise these Terms of Use for its Website at any time
      ...
      <p>
        Please read our <NavLink to={"/privacy-policy"}>Privacy Policy</NavLink>
        .
      </p>
      ...
      <p>
        Any claim related to Niwder.io's Website shall be governed by the laws
        of lk without regards to its conflict of law provisions.
      </p>
    </div>
  );
};
